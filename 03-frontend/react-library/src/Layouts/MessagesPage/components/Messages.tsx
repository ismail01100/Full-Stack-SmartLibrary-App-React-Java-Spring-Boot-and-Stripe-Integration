...
export const Messages = () => {
    ...
    return (
        <div className='mt-2'>
            {messages.length > 0 ? 
                <>
                    <h5>Questions/Réponses actuelles : </h5>
                    {messages.map(message => (
                        <div key={message.id}>
                            <div className='card mt-2 shadow p-3 bg-body rounded'>
                                <h5>Cas #{message.id}: {message.title}</h5>
                                ...
                                <div>
                                    ...
                                    {message.response && message.adminEmail ? 
                                        ...
                                        :
                                        <p><i>En attente de réponse de l'administration. Veuillez patienter.</i></p>
                                    }
                                </div>
                            </div>
                        </div>
                ...
                :
                <h5>Toutes les questions que vous soumettez seront affichées ici</h5>
            }
