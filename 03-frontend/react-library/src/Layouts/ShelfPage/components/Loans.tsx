    ...
    return (
        <div>
                            ...
                            <div className='row mt-3 mb-3'>
                                ...
                                <div className='card col-3 col-md-3 container d-flex'>
                                    <div className='card-body'>
                                        <div className='mt-3'>
                                            <h4>Options de prêt</h4>
                                            {shelfCurrentLoan.daysLeft > 0 && 
                                                <p className='text-secondary'>
                                                    Échéance dans {shelfCurrentLoan.daysLeft} jours.
                                                </p>
                                            }
                                            {shelfCurrentLoan.daysLeft === 0 && 
                                            ...
                                            {shelfCurrentLoan.daysLeft < 0 && 
                                                <p className='text-danger'>
                                                    En retard de {shelfCurrentLoan.daysLeft} jours.
                                                </p>
                                            }
                                            <div className='list-group mt-3'>
                                                ...
                                                Rechercher plus de livres ?
                                                </Link>
                                            </div>
                                        </div>
                                        <hr/>
                                        <p className='mt-3'>
                                            Aidez les autres à trouver leur aventure en donnant votre avis sur votre prêt
                                        </p>
            ...
            <div className='container d-lg-none mt-2'>
                {shelfCurrentLoans.length > 0 ? 
                <>
                    <h5 className='mb-3'>Prêts en cours : </h5>
                                ...
                                <div className='card d-flex mt-5 mb-3'>
                                    <div className='card-body container'>
                                        <div className='mt-3'>
                                            ...
                                            {shelfCurrentLoan.daysLeft > 0 && 
                                                <p className='text-secondary'>
                                                    Dû le {shelfCurrentLoan.daysLeft} jours.
                                                </p>
                                            }
                                            {shelfCurrentLoan.daysLeft === 0 && 
                                                <p className='text-success'>
