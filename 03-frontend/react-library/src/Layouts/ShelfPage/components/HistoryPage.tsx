...
import HistoryModel from '../../../models/HistoryModal';
...
export const HistoryPage = () => {
    ...
    return(
        <div className='mt-2'>
                            ...
                            <div className='row g-0'>
                                ...
                                <div className='col'>
                                        <div className='card-body'>
                                            ...
                                            <hr/>
                                            <p className='card-text'> Prêté le: {history.checkoutDate}</p>
                                            <p className='card-text'> Rendu le: {history.returnedDate}</p>
                                        </div>
                                </div>
                            </div>
                        </div>
            ...
            :
            <>
                <h3 className='mt-3'>Aucun historique actuellement: </h3>
