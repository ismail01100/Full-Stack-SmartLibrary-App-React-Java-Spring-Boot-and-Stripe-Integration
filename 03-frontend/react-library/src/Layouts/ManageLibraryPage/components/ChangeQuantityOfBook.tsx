            ...
            <div className='row g-0'>
                ...
                <div className='mt-3 col-md-4'>
                    <div className='d-flex justify-content-center algin-items-center'>
                        <p>Quantité Totale: <b>{quantity}</b></p>
                    </div>
                    <div className='d-flex justify-content-center align-items-center'>
                        <p>Livres Restants : <b>{remaining}</b></p>
                    </div>
                </div>
                <div className='mt-3 col-md-1'>
                    <div className='d-flex justify-content-start'>
                        <button className='m-1 btn btn-md btn-danger' onClick={deleteBook}>supprimer</button>
                    </div>
                </div>
                <button className='m1 btn btn-md main-color text-white' onClick={increaseQuantity}>Ajouter la Quantité</button>
                <button className='m1 btn btn-md btn-warning' onClick={decreaseQuantity}>Réduire la Quantité</button>
            </div>
        </div>
    );
}